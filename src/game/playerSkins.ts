...
export const PLAYER_SKINS: Record<string, PlayerSkin> = {
  boi: {
    ...
    icon:     { key: 'boi-icon',      path: './personagens/killers/professor/icon/Boi_Icon.png' },
    iconHurt: { key: 'boi-icon-hurt', path: './personagens/killers/professor/icon/Boi_Icon_Hurt.png' },
    totalRows: 3,
    displayWidth: 64,
    displayHeight: 64,
  ...
  clayrton: {
    ...
    icon:     { key: 'clayrton-icon',      path: './personagens/killers/clayrton/icon/Clayrton_Icon.png' },
    iconHurt: { key: 'clayrton-icon-hurt', path: './personagens/killers/clayrton/icon/Clayrton_Icon_Hurt.png' },
    totalRows: 3,
    displayWidth: 64,
    displayHeight: 64,
    bodyOffset: { x: 16, y: 10 },
  ...
  fernanda: {
    ...
    icon:     { key: 'fernanda-icon',      path: './personagens/killers/fernanda/icon/Fernanda_Icon.png' },
    iconHurt: { key: 'fernanda-icon-hurt', path: './personagens/killers/fernanda/icon/Fernanda_Icon_Hurt.png' },
    totalRows: 3,
    displayWidth: 64,
    displayHeight: 64,
    bodyOffset: { x: 16, y: 10 },
  ...
  davi: {
    id: 'davi',
    frameSize: 64,
    idle: { key: 'davi-idle', path: './personagens/survivors/davi/standard/idle.png', totalCols: 13, animCols: 2 },
    walk: { key: 'davi-walk', path: './personagens/survivors/davi/standard/walk.png', totalCols: 13, animCols: 9 },
    run:  { key: 'davi-run',  path: './personagens/survivors/davi/standard/run.png',  totalCols: 13, animCols: 6 },
    sit:  { key: 'davi-sit',  path: './personagens/survivors/davi/standard/sit.png',  totalCols: 13, animCols: 3 },
    hurt: { key: 'davi-hurt', path: './personagens/survivors/davi/standard/hurt.png' },
    icon:     { key: 'davi-icon',      path: './personagens/survivors/davi/icons/Davi_Icon.png' },
    iconHurt: { key: 'davi-icon-hurt', path: './personagens/survivors/davi/icons/Davi_Icon_Hurt.png' },
    displayWidth: 64,
    displayHeight: 64,
    bodyOffset: { x: 16, y: 10 },
  },
