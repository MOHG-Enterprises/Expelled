...
export const PLAYER_SKINS: Record<string, PlayerSkin> = {
  professor: {
    id: 'professor',
    frameSize: 64,
    idle:   { key: 'professor-idle',   path: './personagens/Killers/Professor/standard/idle.png',   totalCols: 13, animCols: 2 },
    walk:   { key: 'professor-walk',   path: './personagens/Killers/Professor/standard/walk.png',   totalCols: 13, animCols: 9 },
    run:    { key: 'professor-run',    path: './personagens/Killers/Professor/standard/run.png',    totalCols: 13, animCols: 6 },
    sit:    { key: 'professor-sit',    path: './personagens/Killers/Professor/standard/sit.png',    totalCols: 13, animCols: 3 },
    combat: { key: 'professor-combat', path: './personagens/Killers/Professor/standard/combat.png', totalCols: 13, animCols: 2 },
    displayWidth: 64,
    displayHeight: 64,
